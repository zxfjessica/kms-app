	...
	global.install = function(vue) {
		vue.prototype.$global = function() {
			...
			if(window.location.port) {
				host = 'http://10.118.12.50:8001';
				userAccount = '015533';
				officeHost = 'http://10.202.78.58:8080/view/url';
			} else {
				host = 'http://10.202.33.121:8080';/*https://kms-mappserver.sf-express.com*//* http://kms-mcmsrepo.sit.sf-express.com */
				userAccount = '015533';
				officeHost = 'http://10.202.78.58:8080/view/url';/*http://kms.sf-express.com/view/url*/
			}
			return {
				host: host,
				userName: userAccount,
				officeHost: officeHost,
				imgHost: 'http://10.202.32.116:8080/KMS/',/*http://kms-mappserver.sf-express.com/KMS/*/
